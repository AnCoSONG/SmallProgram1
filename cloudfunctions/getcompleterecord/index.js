...
exports.main = async (event, context) => {
  ...
  let d_resp = await got('http://129.204.216.249:8080/drinkorder/get/all/completed', {
    method: 'GET',
    headers: {
      accept: "*/*"
    }
  ...
  let b_resp = await got('http://129.204.216.249:8080/batteryorder/get/all/completed', {
    method: 'GET',
    headers: {
      accept: "*/*"
    }
